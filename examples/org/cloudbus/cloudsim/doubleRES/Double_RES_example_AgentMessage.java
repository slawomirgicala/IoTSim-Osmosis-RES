...
public class Double_RES_example_AgentMessage extends AgentMessage {
    ...
    public Double_RES_example_AgentMessage() {
    ...
    public Double_RES_example_AgentMessage(Long id, String source, Set<String> destination) {
