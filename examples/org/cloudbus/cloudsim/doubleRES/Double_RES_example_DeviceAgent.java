...
public class Double_RES_example_DeviceAgent extends DeviceAgent {
    ...
    public Double_RES_example_DeviceAgent() {
    ...
    public void plan() {
        ...
        for(AgentMessage message:messages) {
            Double_RES_example_AgentMessage msg = (Double_RES_example_AgentMessage) message;
            double res = msg.getGreenEnergyRatio();
        ...
        if (!noRES){
            for (AgentMessage message : messages) {
                ...
                double val = - haversineDistance(msg.getLat(), msg.getLon(),
                        getIoTDevice().getLatitude(), getIoTDevice().getLongitude() );

                for (String mel_name : msg.getAvailableMELs()) {
