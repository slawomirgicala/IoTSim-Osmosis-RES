...
public class Double_RES_example_DCAgent extends DCAgent {
    ...
    public Double_RES_example_DCAgent() {
    ...
    public void analyze() {
        ...
        //Create new message.
        Double_RES_example_AgentMessage message = (Double_RES_example_AgentMessage) newAgentMessage();

        //Prepare message content - list of available MELs.
