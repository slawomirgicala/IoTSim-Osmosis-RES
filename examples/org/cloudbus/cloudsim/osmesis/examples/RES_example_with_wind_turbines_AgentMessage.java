...
public class RES_example_with_wind_turbines_AgentMessage extends AgentMessage {
    List<String> availableMELs = new ArrayList<>();

    public RES_example_with_wind_turbines_AgentMessage() {
    ...
    public RES_example_with_wind_turbines_AgentMessage(Long id, String source, Set<String> destination) {
